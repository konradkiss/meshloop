...
bool Material::onAdd()
{
   ...
   if (slash == String::NPos) {
      const String  scriptFile = Con::getVariable("$Con::MatFile");  // overridden material.cs file
   }
   // <<<
...
// >>>
void Material::remapMaterial()
{
   _mapMaterial();
}

ConsoleMethod( Material, remap, void, 2, 2, 
              "remap(): Remap this material even if it has already been loaded." )
{
   object->remapMaterial();
}
// <<<
