...
protected:
   ...
   // >>>
   void reSkin( String newBaseName, String oldBaseName = String::EmptyString, String refPath = String::EmptyString );
   // <<<
...
//-------------------------------------------------------------------------------------
   ...
   // >>>
   /// get the overall count of meshes within the shape
   S32 meshCount() { return mMeshObjects.size(); };
   // <<<
   /// @}
