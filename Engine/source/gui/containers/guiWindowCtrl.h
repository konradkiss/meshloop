...
class GuiWindowCtrl : public GuiContainer
{
   ...
   public:
      ...
      /// Using setDataField is a bit overkill.
      // >>>
      void setCanResize( bool canResizeWidth, bool canResizeHeight, bool canResizeTop = true, bool canResizeBottom = true )
      {
         mResizeWidth = canResizeWidth;
         mResizeHeight = canResizeHeight;
         mResizeTop = canResizeTop;
         mResizeBottom = canResizeBottom;
      }
      // <<<
