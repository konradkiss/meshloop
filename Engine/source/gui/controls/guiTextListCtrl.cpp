...
// >>>
bool GuiTextListCtrl::cellSelected(Point2I cell, bool doubleClick)
{
   // Is the selection being cleared?
   if( cell.x == -1 && cell.y == -1)
      return Parent::cellSelected(cell, doubleClick);
...
void GuiTextListCtrl::onCellSelected(Point2I cell, bool doubleClick)
{
   if (doubleClick) {
      Con::executef(this, "onSelectDblClick", Con::getIntArg(mList[cell.y].id), mList[cell.y].text);
   } else {
